<template>
  <div :class="{'u-video-hover': !hidden}" :style="`width: ${width}px; height: ${height}px;`" class="m-video">
    <video
      ref="veo"
      :autoplay="autoplay"
    ...
    <svg v-show="originPlay || showPlay" :class="{'hidden': hidden}" :style="`width: ${playWidth}px; height: ${playWidth}px;`" class="u-play" viewBox="0 0 24 24">
      <path d="M4.75 6.75C4.75 5.64543 5.64543 4.75 6.75 4.75H17.25C18.3546 4.75 19.25 5.64543 19.25 6.75V17.25C19.25 18.3546 18.3546 19.25 17.25 19.25H6.75C5.64543 19.25 4.75 18.3546 4.75 17.25V6.75Z" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
      <path d="M15.25 12L9.75 8.75V15.25L15.25 12Z" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
    </svg>
  </div>
</template>
<script>
