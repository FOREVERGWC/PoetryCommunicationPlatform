<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="commentList" @selection-change="handleSelectionChange">
      ...
      <!--      <el-table-column label="诗词ID" align="center" prop="poetryId" />-->
      <!--      <el-table-column align="center" label="用户ID" prop="userId"/>-->
      <el-table-column align="center" label="点赞量" prop="favor"/>
...
<script>
import {addComment, delComment, getComment, listComment, updateComment} from "@/api/system/comment";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除诗词评论编号为"' + ids + '"的数据项？').then(function () {
